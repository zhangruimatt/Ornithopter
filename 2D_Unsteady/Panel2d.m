...
% two corners, tangent vec, normal vec, theta(angle between tan & x axis), beta(angle between normal & x axis)
...
classdef Panel2d < handle
    ...
    methods
        ...
        % Reset all important parameters after time steps or initialzation.
