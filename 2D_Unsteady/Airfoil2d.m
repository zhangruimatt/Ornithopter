% Subclass of Body2D, a standard 2d airfoil.

% Methods: Airfoil2d(x,y,le,pp,puccw) (x,y) = coordinates of airfoil nodes; le = index of leading-edge node
%          puccw;  % true/false if pitch up is counterclockwise/clockwise
%          pp: proportion on the chord line for the pitch axis

%          glide(self,dtheta,dx,dy) theta: Angle; dx, dy: coordinates moved
