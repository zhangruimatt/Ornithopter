% Based on Hess, J.L. and Smith, A.M.O., "Calculation of Potential Flow About Arbitrary Bodies", Progress in Aerospace Sciences, 8, pp. 1-138, (1967)
% Include simple naive wake model(bisection) & more complicated one 


% Methods: Wake2d: initialization with position and strength;
%          [vx,vy] = influence(self,x,y): influence at points (x,y)
%          [str,cx,cy] = vortexCores(self): vortex cores(a series of vortices, similar to center of mass calculation)
